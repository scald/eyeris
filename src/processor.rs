...
impl ImageProcessor {
    ...
    async fn analyze_image(
        ...
        let optimized_image = tokio::task
            ::spawn_blocking(move || {
        ...
        tracing::info!(
            ...
            reduction_percent = (((original_size - optimized_image.len()) as f32) /
        ...
        tracing::info!(total_duration_ms = start.elapsed().as_millis(), "Total analysis completed");
